...
function configure() {
    color = (document.getElementById('fillcolor').value == '' || document.getElementById('fillcolor').value == null) ? 'orange' : document.getElementById('fillcolor').value;
    bgcolor = (document.getElementById('bgcolor').value == '' || document.getElementById('bgcolor').value == null) ? 'green' : document.getElementById('bgcolor').value;
